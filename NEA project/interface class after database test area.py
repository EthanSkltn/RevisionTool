...
class Interface:
    ...
    def run_flashcard_system(self):
        ...
        #Flashcard_System(root,self.user_id,self.username,self.main_directory)


    def flashcard_practice(self):
        #FlashcardApp(root,self.username,self.user_id,self.main_directory)
        pass
...
interfacte1 = Interface(root,1980,1080,"ethan",0)